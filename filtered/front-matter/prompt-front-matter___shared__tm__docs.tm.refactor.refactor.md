...
3. Determine categories:
   ...
   - Validated against taxonomy; de-duplicated → [NUMBERED_PLACEHOLDER_1] entries
...
- Artifacts: [NUMBERED_PLACEHOLDER_2] listed (document, boards, changelog)
- Summary: [NUMBERED_PLACEHOLDER_3] characters; grammatically sound
