...
6. Determine provided artifacts (optional):
   ...
   - → {placeholder_6}, {placeholder_7}, {placeholder_8}
...
8. Produce metadata in the requested format:
   - Identifier: `{placeholder_1}`
   - Categories: {placeholder_2}, {placeholder_3}, {placeholder_4}
   - Stage: assessment
   - Dependencies: `{placeholder_5}`
   - Artifacts: {placeholder_6}, {placeholder_7}, {placeholder_8}
