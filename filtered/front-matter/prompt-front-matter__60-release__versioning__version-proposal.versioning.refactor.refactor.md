...
- Identifier: {{identifier}} → matches kebab-case pattern, starts with letter
- Categories: non-empty, drawn from canonical list (≤3)
- Stage: "{{lifecycle_stage}}" is valid per stage hints
- Dependencies: all are git commands, id-shaped, ≤5
- Artifacts: ≤3 items, relevant to output
- Summary: {{summary_length}} characters, coherent and concise
